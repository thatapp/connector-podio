...
exports.process = async function updateItem(msg, cfg) {
    ...
    try {
        ...
        const categoryFields = await helper.getCategoryFieldIds(podio, cfg.appId);
        let data = helper.fieldTransform(item_remodified, true, categoryFields);
        ...
        try {
            data = await helper.mergeImageFieldValues(podio, cfg.appId, item_id, data);
        } catch (mergeError) {
